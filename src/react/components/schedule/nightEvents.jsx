...
const Communicate = () => {
	return (
		<div>
			...
			<section>
				<h3>講者出沒時刻表</h3>
				<p><strong>18:40 - 18:45</strong>黃勝雄 博士 、Karl Lin、民2、 Tony & Clara(SITCON x HK)、ㄅㄌ</p>
				<p><strong>18:45 - 18:50</strong>yenWu、licson、ming、阿哲、PineApple</p>
				<p><strong>18:50 - 19:00</strong>何明諠 先生、飛魚、Terry Cheong、Yukai Huang、Jason Pan、Louie Lu</p>
				<p><strong>19:30 - 20:00</strong>LegBone、Sakamoto、Inndy、adr、游宭鎬、Shouko</p>
				<p>地點：三樓右側沙發區</p>
				<p>注意事項：</p>
				<ul>
